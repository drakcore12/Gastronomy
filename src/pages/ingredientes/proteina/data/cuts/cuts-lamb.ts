export const CUTS_LAMB = [
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'shoulder', en: 'Shoulder', es: 'Paleta' },
    especie: 'cordero',
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'breast', en: 'Breast', es: 'Pecho' },
    especie: 'cordero',
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'rib', en: 'Rib', es: 'Costillar' },
    especie: 'cordero',
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'loin', en: 'Loin', es: 'Lomo' },
    especie: 'cordero',
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'sirloin', en: 'Sirloin', es: 'Cadera' },
    especie: 'cordero',
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'shank', en: 'Shank', es: 'Jarrete' },
    especie: 'cordero',
    metodos: ['Braseado', 'Estofado'],
    grasa: 'media',
    proteina: 'alta',
