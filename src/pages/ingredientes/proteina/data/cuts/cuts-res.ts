export const CUTS_RES = [
  ...
  // ============================================================================
  {
    ...
    primal: { id: 'tender', en: 'Tenderloin', es: 'Lomo fino' },
    especie: 'res',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'shortloin', en: 'Short Loin', es: 'Lomo corto' },
    especie: 'res',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'rib', en: 'Rib', es: 'Costilla' },
    especie: 'res',
    metodos: ['Parrilla', 'Plancha'],
    grasa: 'alta',
    proteina: 'alta',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'topsir', en: 'Top Sirloin', es: 'Solomillo superior' },
    especie: 'res',
    metodos: ['Parrilla', 'Horno'],
    grasa: 'media',
    proteina: 'alta',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'bottomsir', en: 'Bottom Sirloin', es: 'Cuadril' },
    especie: 'res',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'flank', en: 'Flank', es: 'Vacío' },
    especie: 'res',
  ...
  // ==========================================================================
  {
    ...
    primal: { id: 'plate', en: 'Plate', es: 'Falda' },
    especie: 'res',
  ...
  // ==== ROUND ===============================================================
  {
    ...
    primal: { id: 'round', en: 'Round', es: 'Posta / Pierna' },
    especie: 'res',
  ...
  // ==== BRISKET =============================================================
  {
    ...
    primal: { id: 'brisket', en: 'Brisket', es: 'Pecho' },
    especie: 'res',
    metodos: ['Ahumar', 'Horno lento', 'Brasear'],
    grasa: 'alta',
    proteina: 'media',
  ...
  // ==== SHANK ===============================================================
  {
    ...
    primal: { id: 'rshank', en: 'Shank (rear)', es: 'Brazuelo trasero' },
    especie: 'res',
    metodos: ['Brasear'],
    grasa: 'baja',
    proteina: 'media',
  ...
  },
  {
    ...
    primal: { id: 'fshank', en: 'Shank', es: 'Brazuelo' },
    especie: 'res',
  ...
  // ==== CHUCK ===============================================================
  {
    ...
    primal: { id: 'chuck', en: 'Chuck', es: 'Espaldilla' },
    especie: 'res',
  ...
  // ==== OFFAL / VARIEDAD ====================================================
  {
    ...
    primal: { id: 'tongue', en: 'Tongue', es: 'Lengua' },
    especie: 'res',
    metodos: ['Brasear', 'Estofar'],
    grasa: 'media',
    proteina: 'media',
  ...
  },
  {
    ...
    primal: { id: 'cheek', en: 'Cheek', es: 'Cachete' },
    especie: 'res',
    metodos: ['Brasear', 'Estofar'],
    grasa: 'media',
    proteina: 'media',
  ...
  },
  {
    ...
    primal: { id: 'oxtail', en: 'Oxtail', es: 'Rabo' },
    especie: 'res',
